...
#if defined(SL_CATALOG_DEBUG_SYSTEM_PRESENT)
#define SL_SLEEPTIMER_DEBUG_LEVEL_OFF      SL_DEBUG_SYSTEM_LEVEL_OFF
#define SL_SLEEPTIMER_DEBUG_LEVEL_ERROR    SL_DEBUG_SYSTEM_LEVEL_ERROR
#define SL_SLEEPTIMER_DEBUG_LEVEL_WARNING  SL_DEBUG_SYSTEM_LEVEL_WARNING
#define SL_SLEEPTIMER_DEBUG_LEVEL_INFO     SL_DEBUG_SYSTEM_LEVEL_INFO
#else
#define SL_SLEEPTIMER_DEBUG_LEVEL_OFF      0
#define SL_SLEEPTIMER_DEBUG_LEVEL_ERROR    0
#define SL_SLEEPTIMER_DEBUG_LEVEL_WARNING  0
#define SL_SLEEPTIMER_DEBUG_LEVEL_INFO     0
#endif
...
// <o SL_SLEEPTIMER_DEBUG_LEVEL> Debugging events report level. Requires debug system component. Meaningless when not present.
//   <SL_SLEEPTIMER_DEBUG_LEVEL_OFF=> Disabled
//   <SL_SLEEPTIMER_DEBUG_LEVEL_ERROR=> Error
//   <SL_SLEEPTIMER_DEBUG_LEVEL_WARNING=> Warning + Error
//   <SL_SLEEPTIMER_DEBUG_LEVEL_INFO=> Warning + Error + Info
// <i> Default: SL_SLEEPTIMER_DEBUG_LEVEL_WARNING
#define SL_SLEEPTIMER_DEBUG_LEVEL  SL_SLEEPTIMER_DEBUG_LEVEL_WARNING

// <o SL_SLEEPTIMER_DEBUG_ASSERT> Enable debug asserts. Requires debug system component. Meaningless when not present.
// <i> Default: 1
#define SL_SLEEPTIMER_DEBUG_ASSERT 1
